...
class search_pw extends Component {
    ...
    _checkSecretCode = function() {
        ...
        if(String(secret_input).length !== 6) {
            console.log(String(secret_input).length);
            console.log(String(secret_code).length);
    ...
    render() {
        ...
        return (
            <div>
                <Modal
                    visible={this.props.search_pw_modal}
                  ...
                  <div id='search_id_email_div'>
                    ...
                    <div className='search_result_div'>
                        ...
                        <div>
                            ...
                            <input type='text' maxLength='6' name='pw_secret' placeholder='6자리 숫자코드 입력' />
